...
class EntityType(Enum):
    ...
    def from_string(cls, value: str):
        ...
        try:
            ...
            raise ValueError(
                f"Invalid entity type '{value}'. Valid types: {valid_values}"
            )
...
class EntityStatus(Enum):
    ...
    def from_string(cls, value: str):
        ...
        try:
            ...
            valid_values = ", ".join(cls.values())
            raise ValueError(
                f"Invalid status '{value}'. Valid statuses: {valid_values}"
            )
...
class OutputFormat(Enum):
    ...
    def from_string(cls, value: str):
        ...
        try:
            ...
            valid_values = ", ".join(cls.values())
            raise ValueError(
                f"Invalid output format '{value}'. Valid formats: {valid_values}"
            )
...
class SortField(Enum):
    ...
    def from_string(cls, value: str):
        ...
        try:
            ...
            valid_values = ", ".join(cls.values())
            raise ValueError(
                f"Invalid sort field '{value}'. Valid fields: {valid_values}"
            )
