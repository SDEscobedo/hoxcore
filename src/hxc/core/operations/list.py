...
class ListOperation:
    ...
    def load_entities(
        self, entity_type: EntityType, include_file_metadata: bool = True
    ) -> List[Dict[str, Any]]:
        """
    ...
    def list_entities(
        ...
        *,
        ...
        # Sort entities
        sorted_entities = self.sort_entities(filtered_entities, sort_field, descending)
    ...
    def clean_entities_for_output(
        entities: List[Dict[str, Any]], remove_file_metadata: bool = True
    ) -> List[Dict[str, Any]]:
        """
