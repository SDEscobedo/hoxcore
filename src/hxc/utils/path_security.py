...
def resolve_safe_path(
    registry_root: Union[str, Path], target_path: Union[str, Path]
) -> Path:
    """
...
def get_safe_entity_path(
    registry_root: Union[str, Path], entity_type: str, filename: str
) -> Path:
    """
...
def ensure_within_registry(
    registry_root: Union[str, Path], *paths: Union[str, Path]
) -> None:
    """
