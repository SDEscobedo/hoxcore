...
class TestCommitEntityChangeUnit:
    def test_returns_false_when_not_in_git_repo(
        self, temp_dir, sample_entity_data, capsys
    ):
    ...
    def test_returns_false_when_git_not_available(
        self, git_repo, sample_entity_data, capsys
    ):
    ...
    def test_edit_action_includes_changes_in_message(
        self, git_repo, sample_entity_data
    ):
        file_path = git_repo / "proj-abc12345.yml"
        file_path.write_text("test content")
    ...
    def test_error_message_mentions_create_action(
        self, git_repo, sample_entity_data, capsys
    ):
        file_path = git_repo / "proj-abc12345.yml"
        file_path.write_text("test content")
    ...
    def test_error_message_mentions_edit_action(
        self, git_repo, sample_entity_data, capsys
    ):
        file_path = git_repo / "proj-abc12345.yml"
        file_path.write_text("test content")
    ...
    def test_error_message_mentions_delete_action(
        self, git_repo, sample_entity_data, capsys
    ):
        file_path = git_repo / "proj-abc12345.yml"
        file_path.write_text("test content")
...
class TestCommitEntityChangeIntegration:
    ...
    def test_multiple_commits_create_separate_entries(
        self, git_repo, sample_entity_data
    ):
        # Create first entity
