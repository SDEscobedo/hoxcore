...
class TestValidateIdUniqueness:
    ...
    def test_validate_with_preloaded_ids(self, temp_registry):
        ...
        assert operation.validate_id_uniqueness(EntityType.PROJECT, "new-id", existing_ids) is True
        assert operation.validate_id_uniqueness(EntityType.PROJECT, "existing-1", existing_ids) is False
...
class TestResolveAutoId:
    ...
    def test_resolve_auto_id_truncates_for_max_length(self):
        ...
        result = CreateOperation.resolve_auto_id(existing_ids, long_base[:255], "abc12345")
