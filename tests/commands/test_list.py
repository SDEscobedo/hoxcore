...
def temp_registry(tmp_path):
    ...
    # Programs
    create_sample_item(
        programs_dir, "prog-001", "program", "Test Program 1", "PG-001", "active"
    )
    create_sample_item(
        programs_dir, "prog-002", "program", "Test Program 2", "PG-002", "planned"
    )

    # Missions
    create_sample_item(
        missions_dir, "miss-001", "mission", "Test Mission 1", "M-001", "active"
    )

    # Actions
    create_sample_item(
        actions_dir, "act-001", "action", "Test Action 1", "A-001", "active"
    )
    create_sample_item(
        actions_dir, "act-002", "action", "Test Action 2", "A-002", "completed"
    )
...
def test_list_sort_order(mock_get_registry_path, temp_registry):
    ...
    with patch("builtins.print") as mock_print:
        ...
        output_calls = [call[0][0] for call in mock_print.call_args_list]
        project_lines = [
            line for line in output_calls if "Project" in line and "TYPE" not in line
        ]
...
class TestListCommandUsesSharedOperation:
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_cli_passes_all_filters_to_operation(
...
class TestListCommandDateFilters:
    ...
    def temp_registry_with_dates(self, tmp_path):
        ...
        create_sample_project(
            projects_dir, "proj-nodate", "No Date Project", "P-NODATE", "active"
        )
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_filter_before_date(
        self, mock_get_registry_path, temp_registry_with_dates
    ):
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_filter_after_date(
        self, mock_get_registry_path, temp_registry_with_dates
    ):
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_filter_date_range(
        self, mock_get_registry_path, temp_registry_with_dates
    ):
        ...
        with patch("builtins.print") as mock_print:
            result = main(
                ["list", "project", "--after", "2024-04-01", "--before", "2024-10-01"]
            )
...
class TestListCommandQueryFilter:
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_query_matches_title(
        self, mock_get_registry_path, temp_registry_with_descriptions
    ):
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_query_matches_description(
        self, mock_get_registry_path, temp_registry_with_descriptions
    ):
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_query_case_insensitive(
        self, mock_get_registry_path, temp_registry_with_descriptions
    ):
...
class TestListCommandMultipleTags:
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_list_multiple_tags_and_logic(
        self, mock_get_registry_path, temp_registry_with_tags
    ):
...
class TestListCommandBehavioralParityWithMCP:
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_cli_and_operation_produce_same_filter_results(
        self, mock_get_registry_path, temp_registry
    ):
        ...
        with patch("builtins.print") as mock_print:
            result = main(
                ["list", "project", "--status", "completed", "--format", "id"]
            )
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_cli_and_operation_produce_same_sort_order(
        self, mock_get_registry_path, temp_registry
    ):
        ...
        with patch("builtins.print") as mock_print:
            result = main(
                ["list", "project", "--sort", "title", "--desc", "--format", "id"]
            )
...
class TestListCommandOutputFormats:
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_yaml_output_excludes_file_metadata(
        self, mock_get_registry_path, temp_registry
    ):
    ...
    @patch("hxc.commands.registry.RegistryCommand.get_registry_path")
    def test_json_output_excludes_file_metadata(
        self, mock_get_registry_path, temp_registry
    ):
